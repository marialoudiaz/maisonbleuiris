...
export const descriptionprojectsArr: Projet[] = [
          ...
          //georges
          {
            ...
            sections: 
              [
                {
                  ...
                  text: [
                    ...
                    "The visual approach was inspired by natural elements and monastic sobriety. The jar evokes the raw stone of Mount Canigou, while the label takes on the appearance of parchment. The graphic identity is minimal yet imbued with presence: an engraved typeface, a discreet drawing of wild garlic, and a palette reduced to earthy tones and patinated gold. Everything evokes slowness, patience, and the sacredness of the gesture. We designed the packaging like a talisman—modest in appearance, yet laden with memory."
                  ],
                  image: '/images/projets/branding-strategy/georges/georgesaioli-poster-rochercitation.png',
                },
                {
                  subtitle: ["Créer une légende autour de la mémoire", "To create a tale from our memory."],
                  text:[
                    "Né d’une légende enracinée au sommet du Canigou, l’aïoli Georges incarne bien plus qu’un simple condiment : il est la mémoire vivante d’un savoir ancien. Dans le désir d’honorer cette mémoire à travers un projet à partager, pour continuer de la faire vivre dans le présent, nous avons imaginé une légende autour d'une figure totem du nom de Georges, l’ermite catalan. Cette histoire se traduit graphiquement par la création d’un logotype inspiré de sa signature, auquel s’ajoute une typographie des années 50 pour le nom AIOLI CATALAN, ancrant visuellement la recette dans l’époque et l’héritage des terres catalanes. Le timbre, apposé sur le couvercle tel un sceau, complète l’ensemble. On y retrouve le rouge du drapeau catalan, les coordonnées GPS du sommet du Canigou, ses lignes de crêtes, et deux izards sauvages, gardiens silencieux de cette terre. Le timbre, c’est l’invitation au voyage. Le sceau d’une promesse.",
                    "Born from a legend rooted at the summit of Mount Canigou, Georges aioli embodies far more than a simple condiment: it is the living memory of an ancient craft. With the desire to honor this memory through a project meant to be shared, and to keep it alive in the present, we imagined a legend around a totemic figure named Georges, the Catalan hermit. This story is translated graphically through the creation of a logotype inspired by his signature, complemented by a 1950s-style typeface for the name AIOLI CATALAN, visually anchoring the recipe in the era and heritage of Catalan lands. The stamp, affixed to the lid like a seal, completes the whole. It features the red of the Catalan flag, the GPS coordinates of the Canigou summit, its ridgelines, and two wild izards, silent guardians of this land. The stamp is an invitation to travel. The seal of a promise."
                  ],
              ...
              sectionsImg: 
              [
                ['/images/projets/branding-strategy/georges/etiquette-pot.jpg','/images/projets/branding-strategy/georges/boite-georges.jpg'],
                ['/images/projets/branding-strategy/georges/etiquette-pot.jpg','/images/projets/branding-strategy/georges/boite-georges.jpg'],
              ]
          },
          //vb
          {
                ...
                [
                  ...
                  text: [
                    "La palette vert et argenté et le symbole de Thémis ont été choisis pour incarner les valeurs fondamentales de la firme d’avocats. Le vert symbolise l’équilibre, l’harmonie et la justice. Il évoque aussi la croissance, la confiance et l’espoir, des notions essentielles pour accompagner leurs clients vers des solutions justes et durables. L’argenté incarne la modernité, la rigueur et la transparence. Il reflète leur engagement à offrir des services clairs, efficaces et innovants, tout en garantissant une approche professionnelle et intègre. Le symbole de Thémis, déesse de la justice, représente l’équité, l’impartialité et la vérité. Avec sa balance, elle incarne la recherche constante d’équilibre et de justesse dans leurs actions, tandis que son glaive rappelle notre détermination à défendre les droits de leurs clients avec force et conviction. Cette identité visuelle traduit parfaitement leur mission : allier tradition et modernité pour défendre les intérêts de leurs clients avec excellence, intégrité et humanité.",
                    "The green and silver palette and the symbol of Themis were chosen to embody the core values of the law firm. Green symbolizes balance, harmony, and justice. It also evokes growth, trust, and hope—essential notions for guiding their clients toward fair and sustainable solutions. Silver embodies modernity, rigor, and transparency. It reflects their commitment to providing clear, efficient, and innovative services, while ensuring a professional and ethical approach. The symbol of Themis, goddess of justice, represents equity, impartiality, and truth. With her scales, she embodies the constant pursuit of balance and fairness in their actions, while her sword recalls their determination to defend their clients’ rights with strength and conviction. This visual identity perfectly conveys their mission: to combine tradition and modernity in order to defend their clients’ interests with excellence, integrity, and humanity."
                  ],
          ...
          // nda
          {
            ...
            besoins:[
              ["Naissance d'une amitié est un roman d'Émile Trubert qui explore avec délicatesse l’émergence d’une amitié émouvante. Au cœur de l’histoire se trouve un vieil homme, accablé par le poids du deuil après la perte de son épouse bien-aimée, rencontre Eva qui va progressivement transformer son monde en ruines en une nouvelle réalité lumineuse. Leur lien devient une source de guérison, ramenant peu à peu chaleur et espoir dans sa vie. La couverture cherche par l'utilisation de l'encre comme médium et le déplacement d'un mode monochromatique vers une bichromie jaune/bleu à traduire ce nouveau changement de paradigme du héros. La figure du protagoniste, initialement enveloppé dans des teintes sombres et ternes, symbolisant son chagrin et son isolement se transforme sur l'illustration comme au fil de l’histoire, à mesure que son amitié avec Eva s’approfondit."],
              ["Birth of a Friendship is a novel by Émile Trubert that delicately explores the emergence of a moving friendship. At the heart of the story is an old man, weighed down by grief after the loss of his beloved wife, who meets Eva, a woman who will gradually transform his ruined world into a new, luminous reality. Their bond becomes a source of healing, slowly bringing warmth and hope back into his life. The cover seeks, through the use of ink as a medium and the shift from a monochromatic mode to a yellow/blue bichromy, to convey this new change in the hero’s paradigm. The figure of the protagonist, initially enveloped in dark, dull tones symbolizing his sorrow and isolation, transforms in the illustration as in the course of the story, as his friendship with Eva deepens."]
            ],
            technologies: [
          ...
          // pascale
          {
                  ...
                  [
                    ...
                    video: '/images/projets/web/pl/pl-ecran-scroll.mp4',
                    },
                    {title:'Pascale Laffon',
                      categories: [
